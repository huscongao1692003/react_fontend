                  ...
                  <div className="c-details-sidebar">
                     ...
                     <div className="course-details-widget">
                        ...
                        <div className="cd-information mb-35">
                           <ul>
                              <li>
                                 <i className="fa-light fa-calendars"></i> <label>Lesson</label>{' '}
                                 <span>{courseData.numLesson || '36'}</span>
                              </li>
                              <li>
                                 <i className="fi fi-rr-chart-pie-alt"></i> <label>Quizess</label>{' '}
                              ...
                              <li>
                                 <i className="fa-light fa-clock-desk"></i> <label>Duration</label>{' '}
                                 <span>{courseData.duration || '16 Hours'}</span>
                              </li>
                              <li>
                                 <i className="fi fi-sr-stats"></i> <label>Skill Level</label>{' '}
                                 <span>{courseData.skillName || 'Beginner'}</span>
                              </li>
                              <li>
                                 <i className="fi fi-rr-comments"></i> <label>Language</label>{' '}
                                 <span>{courseData.language || 'English'}</span>
                              </li>
                              <li>
                                 <i className="fi fi-rs-diploma"></i> <label>Certificate</label>{' '}
